...
public:
    ...
    void setupUi(QWidget *Signup)
    {
        ...
        label_image->setGeometry(QRect(60, 90, 221, 311));
        layoutWidget = new QWidget(Signup);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(340, 90, 291, 211));
        ...
        pushButton_2->setGeometry(QRect(360, 360, 91, 40));
        pushButton_2->setMinimumSize(QSize(0, 40));
        pushButton_2->setStyleSheet(QString::fromUtf8(""));
        btn_return = new QPushButton(Signup);
        btn_return->setObjectName("btn_return");
        btn_return->setGeometry(QRect(480, 360, 91, 40));
