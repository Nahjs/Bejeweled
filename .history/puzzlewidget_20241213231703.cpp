...
void PuzzleWidget::onUpdatePixmap()
{
    ...
    m_offsetPoint.rx() = qBound(0, baseX + QRandomGenerator::global()->bounded(xSection), maxX);
    m_offsetPoint.ry() = qBound(0, baseY + QRandomGenerator::global()->bounded(ySection), maxY);
